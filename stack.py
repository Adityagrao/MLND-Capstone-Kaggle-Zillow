...
class Stacker:
    ...
    def read_meta_feature(self):
        self.meta_train = pd.read_csv('/output/meta_features/train_' + str(self.month) + '.csv')
        self.meta_test = pd.read_csv('/output/meta_features/test_' + str(self.month) + '.csv')
    ...
    def create_meta_feature(self):
        ...
        self.meta_train.to_csv('/output/meta_features/train_' + str(self.month) + '.csv', index=False)
        self.meta_test.to_csv('/output/meta_features/test_' + str(self.month) + '.csv', index=False)
