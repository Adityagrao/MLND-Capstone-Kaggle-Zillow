...
class Data:
    ...
    def preprocess(self, year):
        ...
        print("Writing Train and Testing file")
        # self.train.to_csv('/output/train' + str(year) + '.csv')
        # self.test.to_csv('/output/test' + str(year) + '.csv')
